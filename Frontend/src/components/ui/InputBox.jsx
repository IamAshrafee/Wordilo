 ...
 * USAGE MANUAL
 *
 * This is a reusable InputBox component that is compatible with react-hook-form.
 *
 * PROPS
 * - id (string, required): The id of the input.
 * - name (string, required): The name of the input, used for form handling.
 * - label (string, required): The label for the input.
 * - type (string, optional): The type of the input (e.g., "text", "email", "password"). Defaults to "text".
 * - placeholder (string, optional): The placeholder text for the input.
 * - icon (React.Component, optional): The icon to display inside the input.
 * - error (string, optional): The error message to display.
 * - optional (boolean, optional): Whether the input is optional.
 * - ...props: Any other props will be spread to the input element.
 *
 * EXAMPLE
 *
